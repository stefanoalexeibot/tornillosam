  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="container mx-auto max-w-7xl px-6 py-8 flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="flex items-center justify-between bg-white px-6 py-4 rounded-3xl border border-slate-200">
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-32 space-y-4">
                ...
                <div className="text-center">
                  <p className="text-slate-900 font-black text-lg">Cargando Inventario</p>
                  <p className="text-slate-500 text-sm">Consultando base de datos en tiempo real...</p>
                </div>
              </div>
